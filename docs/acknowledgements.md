---
title: Anerkennungen
description: Vite baut auf den Errungenschaften großer Vorbilder auf. Wir möchten allen Projekten, Mitwirkenden und Sponsoren, die Vite erst möglich machen, unseren Dank aussprechen.
---
...
Vite baut auf den Errungenschaften großer Vorbilder auf. Wir möchten allen Projekten, Mitwirkenden und Sponsoren, die Vite erst möglich machen, unseren Dank aussprechen.

## Beitragende

Vite wird von einem internationalem Team von Beitragenden entwickelt. Schauen Sie sich die [Team-Seite](/team) an, um die Mitglieder des Kernteams kennenzulernen.

Wir danken auch allen [Beitragenden auf GitHub](https://github.com/vitejs/vite/graphs/contributors), welche durch Code-Beiträge, Bug-Meldungen, Dokumentationen und Übersetzungen von Dokumentationen zu der Verbesserung von Vite beigetragen haben.

## Sponsoren

Die Entwicklung von Vite wird aktuelle von großzügigen Sponsoren unterstützt. Sie können Vite auch durch [GitHub Sponsors](https://github.com/sponsors/vitejs) oder [Open Collective](https://opencollective.com/vite) unterstützen.
...
Vite stützt sich auf diese großartigen Open-Source-Projekte:
...
### Autoren der mitgelieferten Abhängigkeiten
...
::: tip Für Paket-Autoren
Dieser Bereich wird automatisch generiert durch die `author` und `funding` Felder in der jeweiligen `package.json` des Pakets. Falls Sie aktualisieren möchten, wie Ihr Paket hier dargestellt wird, können Sie die Felder ganz einfach in Ihrem Paket aktualisieren.
:::

## Entwicklungstools

Der Entwicklungsablauf von Vite wird durch die folgenden Tools unterstützt:
...
## Ältere wichtige Abhängigkeiten

Wir danken auch den Betreuern der Projekte, die Vite in älteren Versionen benutzt hat:
